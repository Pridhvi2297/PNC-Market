...
const Category = () => {
  ...
  const { loader, successMessage, errorMessage, categorys } =
    categoryState || {};
      ...
      <div className="flex flex-wrap w-full">
                  ...
                  <tr key={""}>
                    ...
                    >
                      <img
                        ...
                        src={
                          "https://www.renderhub.com/madmix/apple-iphone-15-pro-max-v2/apple-iphone-15-pro-max-v2-01.jpg"
                        }
                        alt=""
                      />
                    </td>
        ...
        >
          <div className="w-full pl-5">
            <div className="bg-black h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]">
