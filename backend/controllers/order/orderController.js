...
class OrderController {
  ...
  placeOrder = async (req, res) => {
    ...
    try {
      ...
      responseReturn(res, 201, { message: "order placed success", orderId: order.id });
    } catch (error) {
  ...
  getCustomerDashboardData = async (req, res) => {
    ...
    try {
      ...
      responseReturn(res, 200, { recentOrders, pendingOrder, cancelledOrder, totalOrder });
    } catch (error) {
      console.log(error.message);
    }
  }

  // Get orders based on status for a customer
  ...
  // Get details of a single order for a customer
  ...
  // Get details of a single admin order
  ...
  // Update status of an admin order
  ...
  // Get details of a single seller order
  ...
  orderConfirm = async (req, res) => {
    ...
    try {
      ...
      await myShopWallet.create({ amount: cuOrder.price, manth: splitTime[0], year: splitTime[2] });
