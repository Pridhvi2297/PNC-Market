            ...
            <div className='flex flex-wrap w-full'>
                ...
                <div className={`w-[320px] lg:w-5/12 translate-x-100 lg:relative lg:right-0 fixed ${show ? 'right-0' : '-right-[340px]'} z-[9999] top-0 transition-all duration-500`}>
                    <div className='w-full pl-5'>
                        <div className='bg-black h-screen lg:h-auto px-3 py-2 lg:rounded-md text-white'>
                            ...
                            <form onSubmit={add_category}>
                                <div className='flex flex-col w-full gap-1 mb-3'>
                                    ...
                                    <input value={state.name} onChange={(e) => setState({ ...state, name: e.target.value })} className='px-4 py-2 focus:border-indigo-500 outline-none bg-black border border-slate-700 rounded-md text-white' type="text" id='name' name='category_name' placeholder='category name' required />
                                </div>
                                <div>
