...
const Headers = () => {
  ...
  return (
    <div className="w-full bg-[#1ef7ec]">
      <div className="header-top bg-[#63d9f3] md-lg:hidden">
        <div className="w-[85%] lg:w-[90%] mx-auto">
          <div className="flex w-full justify-between items-center h-[50px] text-slate-900">
            <ul className="flex justify-start items-center gap-8">
              <li className="flex relative justify-center items-center gap-2 text-sm after:absolute after:h-[18px] after:w-[1px] after:bg-[#221919] after:-right-[16px]">
                <span>
                  <FcFeedback size={30} />
                </span>
                <a
                  href="mailto:pncmart22@gmail.com?subject=Customer%20Feedback"
                  className="font-bold"
                >
                  pncmart22@gmail.com
                </a>
              ...
              <span className="font-bold">PNC Marketplace</span>
            </ul>
            <div>
        ...
        >
          <div className="flex justify-start flex-col gap-6">
            ...
            <ul className="flex flex-col justify-start items-start gap-3 text-[#1c1c1c]">
              ...
              <span className="text-sm">PNC Marketplace</span>
            </ul>
          </div>
        </div>
      </div>
      <div className="w-[85%] lg:w-[90%] mx-auto">
        <div className="flex w-full flex-wrap md-lg:gap-8">
          <div className="w-52 md-lg:w-full">
