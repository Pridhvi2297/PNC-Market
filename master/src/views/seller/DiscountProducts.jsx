            ...
            <div className='w-full p-4 bg-black rounded-md'>
                ...
                <div className='relative overflow-x-auto mt-5'>
                    <table className='w-full text-sm text-left text-white'>
                        ...
                        <tbody>
                            {products
                                .filter((d) => d.discount > 0) // Filter out products with no discount
                                .map((d, i) => (
                                    <tr key={i}>
                ...
                {totalProduct <= perPage ? (
                    ...
                    <div className='w-full flex justify-end mt-4 bottom-4 right-4'>
                        <Pagination pageNumber={currentPage} setPageNumber={setCurrentPage} totalItem={50} perPage={perPage} showItem={4} />
                    </div>
                )}
            </div>
        </div>
