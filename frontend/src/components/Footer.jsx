...
const Footer = () => {
  ...
  const card_product_count = useState("6");
  const wishlist_count = useState("6");
    const userInfo = true
                ...
                <div className='w-3/12 lg:w-4/12 sm:w-full'>
                    <div className='flex flex-col gap-3'>
                        ...
                        <ul className='flex flex-col gap-2 text-slate-600'>
                            <li>Address : Grand Rapids, Mi</li>
                            <li>Phone : 123 123 1234</li>
                            <li>Email : pncmart22@gmail.com</li>
                        </ul>
                    </div>
                </div>
                ...
                <div className='w-4/12 lg:w-full lg:mt-6'>
                    <div className='w-full flex flex-col justify-start gap-5'>
                        ...
                        <ul className='flex justify-start items-center gap-3'>
                            <li>
                                <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-white rounded-full' href="/"><FaSquareFacebook /></a>
                            </li>
                            <li>
                                <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-white rounded-full' href="/"><BsTwitterX /></a>
                            </li>
                            <li>
                                <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-white rounded-full' href="/"><ImGithub /></a>
                            </li>
                            <li>
                                <a className='w-[38px] h-[38px] hover:bg-[#7fad39] hover:text-white flex justify-center items-center bg-white rounded-full' href="/"><ImGooglePlus2 /></a>
                            </li>
                        </ul>
                    </div>
                </div>
