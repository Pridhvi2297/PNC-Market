      ...
      <div className="w-full p-4  bg-black rounded-md">
        <div className="flex justify-between items-center">
          <select
            ...
            className="px-4 py-2 focus:border-indigo-500 outline-none bg-white border border-slate-700 rounded-md text-[#d0d2d6]"
          >
        ...
        <div className="relative mt-5 overflow-x-auto">
          <div className="w-full text-sm text-left">
            <div className="text-sm text-[#d0d2d6] uppercase border-b border-black">
            ...
            <div className="text-[#d0d2d6]">
              <div className="flex justify-between items-start border-b border-slate-700">
                ...
                <div className="py-4 w-[13%]">$450</div>
              ...
              >
                <div className="flex justify-start items-start border-b border-slate-700">
                  ...
                  <div className="py-4 w-[13%]">$450</div>
                  <div className="py-4 w-[18%]">Paid</div>
                  <div className="py-4 w-[18%]">Warehouse</div>
                </div>
              </div>
            </div>
          </div>
